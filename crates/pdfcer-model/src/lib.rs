//! The pdfcer COS model layer: objects, lexer, parser, filters, xref
//! tables and streams, object streams, recovery, `Document`, the read-only
//! `DocumentView`, the writer (full and incremental save), standard-handler
//! crypto, content-stream parsing and the page tree.
//!
...
///
/// ```
/// use pdfcer_model::{probe_header, PdfVersion};
///
