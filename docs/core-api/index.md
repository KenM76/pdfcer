...
| [`03-capabilities.md`](03-capabilities.md) | ce dimensions, forms, markup, redaction, OCR, print/imposition, rasterising, raster export — each with **★ what the UI must disclose** | 2,924 lines · 70 clauses cited |
