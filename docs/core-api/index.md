...
| [`02-editing-and-saving.md`](02-editing-and-saving.md) | `EditSession` end to end — **all 204 public verbs**, the command/undo contract, the dirty set, the save path, the guard/refusal model, `EditError`'s 122 variants | 4,700 lines · 140 clauses cited |
| [`03-capabilities.md`](03-capabilities.md) | ce dimensions, forms, markup, redaction, OCR, print/imposition, rasterising, raster export — each with **★ what the UI must disclose** | 3,059 lines · 74 clauses cited |
