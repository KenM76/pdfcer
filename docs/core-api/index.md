...
| [`02-editing-and-saving.md`](02-editing-and-saving.md) | `EditSession` end to end — **all 239 public verbs**, the command/undo contract, the dirty set, the save path, the guard/refusal model, `EditError`'s 135 variants | 5,408 lines · 179 clauses cited |
