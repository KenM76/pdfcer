...
| [`02-editing-and-saving.md`](02-editing-and-saving.md) | `EditSession` end to end — **all 250 public verbs**, the command/undo contract, the dirty set, the save path, the guard/refusal model, `EditError`'s 138 variants | 5,647 lines · 184 clauses cited |
| [`03-capabilities.md`](03-capabilities.md) | ce dimensions, forms, markup, redaction, **off-canvas content**, OCR, print/imposition, rasterising, raster export — each with **★ what the UI must disclose** | 3,874 lines · 103 clauses cited |
