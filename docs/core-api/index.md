...
| [`02-editing-and-saving.md`](02-editing-and-saving.md) | `EditSession` end to end — **all 211 public verbs**, the command/undo contract, the dirty set, the save path, the guard/refusal model, `EditError`'s 127 variants | 4,806 lines · 152 clauses cited |
