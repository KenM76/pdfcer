...
| [`02-editing-and-saving.md`](02-editing-and-saving.md) | `EditSession` end to end — **all 244 public verbs**, the command/undo contract, the dirty set, the save path, the guard/refusal model, `EditError`'s 138 variants | 5,576 lines · 184 clauses cited |
