...
| [`02-editing-and-saving.md`](02-editing-and-saving.md) | `EditSession` end to end — **all 188 public verbs**, the command/undo contract, the dirty set, the save path, the guard/refusal model, `EditError`'s 118 variants | 4,491 lines · 131 clauses cited |
| [`03-capabilities.md`](03-capabilities.md) | ce dimensions, forms, markup, redaction, OCR, print/imposition, rasterising, raster export — each with **★ what the UI must disclose** | 2,989 lines · 73 clauses cited |
