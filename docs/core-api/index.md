...
| [`03-capabilities.md`](03-capabilities.md) | ce dimensions, forms, markup, redaction, OCR, print/imposition, rasterising — each with **★ what the UI must disclose** | 2,781 lines · 66 clauses cited |
