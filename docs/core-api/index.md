...
| [`02-editing-and-saving.md`](02-editing-and-saving.md) | `EditSession` end to end — **all 246 public verbs**, the command/undo contract, the dirty set, the save path, the guard/refusal model, `EditError`'s 138 variants | 5,590 lines · 184 clauses cited |
