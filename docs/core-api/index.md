...
| [`03-capabilities.md`](03-capabilities.md) | ce dimensions, forms, markup, redaction, OCR, print/imposition, rasterising, raster export — each with **★ what the UI must disclose** | 3,194 lines · 82 clauses cited |
