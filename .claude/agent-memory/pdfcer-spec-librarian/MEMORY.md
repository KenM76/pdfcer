...
- [PDF_Spec corpus conventions + dispatch-shape playbook](project_corpus_state.md) — 73 numbered items, one per past dispatch. **Find the item matching your dispatch's SHAPE and read it first.** Naming, banners, grading vocabulary, negative-result evidencing, index-filing mechanics.
