...
- [PDF_Spec corpus conventions + dispatch-shape playbook](project_corpus_state.md) — 82 items, one per past dispatch. **Find the item matching your dispatch's SHAPE and read it before working.**
